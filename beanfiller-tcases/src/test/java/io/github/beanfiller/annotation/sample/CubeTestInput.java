...
public class CubeTestInput {

    @RangeVar(min = 1, max = 2)
    int x;

    @RangeVar(min = 11, max = 12)
    int y;

    @RangeVar(min = 21, max = 22)
    int z;


    public static void main(String[] args) {
        int tupleSize = 1;
        List<CubeTestInput> testCases = new FunctionTestsCreator<>(CubeTestInput.class)
